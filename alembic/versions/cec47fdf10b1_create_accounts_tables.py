...
Revision ID: cec47fdf10b1
Revises: 
Create Date: 2026-09-11 12:28:59.081118
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('uuid', sa.UUID(as_uuid=False).with_variant(sa.String(length=36), 'sqlite'), nullable=False),
    sa.Column('name', sa.String(length=255), nullable=False),
