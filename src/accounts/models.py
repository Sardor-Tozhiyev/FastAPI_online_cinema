...
def _activation_expiry() -> datetime:
    return datetime.now(timezone.utc) + timedelta(hours=settings.ACTIVATION_TOKEN_EXPIRE_HOURS)
...
class ActivationToken(Base):
    ...
    expires_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=_activation_expiry)
...
class PasswordResetToken(Base):
    ...
    expires_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=_reset_expiry)
...
class RefreshToken(Base):
    ...
    expires_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), default=_refresh_expiry)
