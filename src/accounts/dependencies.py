...
# tokenUrl is documentation-only; actual login endpoint accepts JSON, not form data.
oauth2_scheme = OAuth2PasswordBearer(tokenUrl="/api/v1/accounts/login", auto_error=False)
