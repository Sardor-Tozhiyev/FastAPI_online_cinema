...
async def test_reply_to_invalid_parent_returns_400(
    client: AsyncClient,
    db_session: AsyncSession,
    strong_password: str,
    certification: Certification,
...
async def test_like_and_unlike_comment(
    ...
    # Liking again is idempotent -- still counts as one like.
